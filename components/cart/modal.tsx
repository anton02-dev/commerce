  ...
  return (
    <>
      ...
      <Transition show={isOpen}>
        <Dialog onClose={closeCart} className="relative z-[9999999999999999]">
          <Transition.Child
            as={Fragment}
          ...
          >
            <Dialog.Panel className="fixed bottom-0 right-0 top-0 flex h-full w-full flex-col border-l border-neutral-200 bg-white/80 p-6 text-black backdrop-blur-xl md:w-[390px] ">
              <div className="flex items-center justify-between">
                <p className="text-lg font-semibold">Cosul de cumparaturi</p>
                ...
                <div className="flex h-full flex-col justify-between overflow-hidden p-1">
                  ...
                  <div className="py-4 text-sm text-neutral-500">
                    ...
                    <div className="mb-3 flex items-center justify-between border-b border-neutral-200 pb-1 pt-1 ">
                      <p>Transport</p>
                      <p className="text-right">Calculat la checkout</p>
                    </div>
                    <div className="mb-3 flex items-center justify-between border-b border-neutral-200 pb-1 pt-1 ">
                      <p>Total</p>
                      <Price
...
function CheckoutButton() {
  ...
  return (
    <button
      ...
      disabled={pending}
    >
      {pending ? <LoadingDots className="bg-white" /> : 'Continua spre checkout'}
    </button>
  );
}
