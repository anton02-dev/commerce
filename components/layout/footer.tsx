...
export default async function Footer() {
  ...
  return (
    <footer className="text-white overflow-hidden">
      {/* Social Media Icons */}
      <div className="border-b border-neutral-800 py-4 bg-[#FCEFDF] text-black">
      ...
      {/* Main Footer Content */}
      <div className="mx-auto w-full py-12 bg-black px-6 md:px-[8px] lg:px-[20px] xl:px-[40px] 2xl:px-[180px]">
        ...
        {/* Call to Action Text */}
        <div className="mt-8 text-center md:text-left max-w-2xl mx-auto md:mx-0">
          <h3 className="text-lg font-semibold mb-2">Fii la curent cu toate nouatatile</h3>
          <p className="text-neutral-300 mb-2">
            Aflați noutățile și promoțiile noastre despre Grătare de curte pentru grădina dumneavoastră!
          </p>
          <p className="text-neutral-300">
            Urmăriți canalele noastre de Social Media de mai sus.
          </p>
        </div>
      </div>
